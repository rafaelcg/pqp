...
Thanks for wanting to. pqp is built by one person in his spare time, so a good
bug report is worth as much as a patch, and telling me something is confusing is
worth more than both.

**Português:** pode abrir issue e PR em português. Eu respondo nos dois idiomas.
...
**Bigger than that?** Open an issue and talk to me first. Not for ceremony:
this project has opinions that are not obvious from the outside, and I would
rather disagree with you before you spend a weekend than after. A feature that
works fine but pulls the product somewhere I do not want to go is the worst
outcome for everybody, and it is entirely my fault if I let you build it.

**Reporting instead of fixing is a real contribution.** If you used pqp with
friends and something annoyed you, tell me. I have very little of that kind of
...
statement that the work is yours to give. It does **not** assign anything to me.
...
service that earns revenue. That is normal for open source and I would rather
...
your contributions exactly as it applies to mine.

If pqp ever needs to be licensed on other terms to somebody, that requires the
permission of everyone who holds copyright in it, including you. I am not asking
for that permission in advance.

## Review

I am one person. Expect days, not hours, and nudge me if it goes quiet. That is
not rudeness, it is helpful.
