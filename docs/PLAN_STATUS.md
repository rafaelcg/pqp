...
| Outgoing channel webhooks | Done (server-scoped HTTPS POST after a human message; Standard Webhooks HMAC; outbox + DLQ; Integrations settings. Not a bot API. [`OUTGOING_WEBHOOKS.md`](./OUTGOING_WEBHOOKS.md)) |
