...
| Character HTTP send | Done (`POST /api/channels/:id/messages` as `Bearer character:<token>`; same create path and send budget as WS; behind `CHARACTER_ACCOUNTS_ENABLED`. [`BOT_SEND.md`](./BOT_SEND.md)) |
