...
Status: M1 to M5 landed in code. `CLUSTER_BUS=postgres` and `VOICE_REGISTRY=postgres` are on in production since 2026-09-07, next to LiveKit. Two machines ran for 2 h 39 min on 2026-09-07 (note below) and production is back to one by choice; M6 is the flip. Written 2026-09-06, the night after the MoonKase watch party incident. Owner: solo maintainer. Budget envelope: ~$165/month total infra.
