...
Status: M1 to M5 landed in code, flag off everywhere, production still one machine (M6 is the flip). Written 2026-09-06, the night after the MoonKase watch party incident. Owner: solo maintainer. Budget envelope: ~$165/month total infra.
