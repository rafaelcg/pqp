...
Enforcement as it stands: with more than one live lease, a room nobody has
pinned opens on LiveKit when configured and on mesh otherwise; a room pinned
elsewhere is adopted; nothing is refused for being mesh. The boot warning
(`voice.meshClusterUnsafe`) went with the refusal.
