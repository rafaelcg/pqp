...
Status: M1 landed in code, flag off everywhere. Written 2026-09-06, the night after the MoonKase watch party incident. Owner: solo maintainer. Budget envelope: ~$165/month total infra.
...
- **M2 to M6**: not started. Do not scale past one machine before M3 (dead-instance reconcile) and M5 (mesh guard, drain).
