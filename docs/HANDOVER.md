...
- **Cargos hint (2026-08-28):** one corner card for people who can manage cargos, once per device. CTA opens server settings on Cargos. localhost never records the impression, so a refresh brings the card back.
