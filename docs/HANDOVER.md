...
- **Outgoing channel webhooks (2026-08-29):** server settings → Integrations. After a human message commits, pqp enqueues a Standard Webhooks-signed `message.created` POST. Character, incoming-webhook, and labeled-bot authors are skipped. Merging **restarts `pqp-api`**. Incoming webhooks are unchanged. [`OUTGOING_WEBHOOKS.md`](./OUTGOING_WEBHOOKS.md).
