...
const BODIES: Record<string, Record<BlogLocale, () => Promise<string>>> = {
  "call-avisa-som-iphone": {
    "pt-BR": () =>
      import("@/content/blog/call-avisa-som-iphone.pt-BR.md?raw").then(
        (m) => m.default,
      ),
    en: () =>
      import("@/content/blog/call-avisa-som-iphone.en.md?raw").then(
        (m) => m.default,
      ),
  },
  ...
  "automod-e-esconder-o-chat": {
    ...
    en: () =>
      import("@/content/blog/automod-e-esconder-o-chat.en.md?raw").then(
        (m) => m.default,
      ),
  },
  "watch-party-e-o-aa": {
    "pt-BR": () =>
      import("@/content/blog/watch-party-e-o-aa.pt-BR.md?raw").then(
        (m) => m.default,
      ),
    en: () =>
      import("@/content/blog/watch-party-e-o-aa.en.md?raw").then(
        (m) => m.default,
      ),
  },
  "bau-e-o-dm-na-barra": {
    "pt-BR": () =>
      import("@/content/blog/bau-e-o-dm-na-barra.pt-BR.md?raw").then(
        (m) => m.default,
      ),
    en: () =>
      import("@/content/blog/bau-e-o-dm-na-barra.en.md?raw").then(
        (m) => m.default,
      ),
  },
  ...
  "dados-discord-e-cargos": {
    ...
    en: () =>
      import("@/content/blog/dados-discord-e-cargos.en.md?raw").then(
        (m) => m.default,
      ),
  },
  "fim-do-eco": {
