 ...
 * like a broken camera. It also matches `CAMERA_RUNG` in
 * `server/src/voice/hls-ladder.ts`: the camera egress transcodes at 360p30,
 * so a presenter publishing anything bigger is spending uplink the HLS
 * audience never sees either.
 *
