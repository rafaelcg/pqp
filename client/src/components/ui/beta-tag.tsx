...
export function BetaTag({
  ...
  return (
    <span
      className={cn(
        "inline-flex shrink-0 items-center rounded-full border px-1.5 py-0.5 text-[10px] font-semibold uppercase leading-none tracking-[0.14em] transition-[color,border-color,background-color] duration-[var(--duration-base)]",
        variant === "hero"
