...
export function WatchPartyBarSlot({
  ...
  return (
    <div
      ...
      className={cn(
        placement === "stage"
          ? // z-30 over the stage's own chrome; `empty:hidden` so a slot with
            // nothing portalled into it (a viewer whose bar is on the player,
            // a state with no controls at all) draws no gradient.
