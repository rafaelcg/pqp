 ...
 * Fullscreen is the same cinema path the seatless watch stage uses: native
 * fullscreen, film fills the screen, chat overlays rather than taking a column.
 */
            ...
            <div className="flex -space-x-1.5">
              {strip.map((person) => (
                <UserAvatar
                  ...
                  rounded="full"
                  className="h-5 w-5 ring-2 ring-black"
                />
              ))}
            </div>
            <p className="truncate text-[11px] font-medium text-paper/80">
